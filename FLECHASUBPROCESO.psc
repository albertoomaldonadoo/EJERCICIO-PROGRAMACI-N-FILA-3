...
SubProceso realizarflecha(alturaflecha)
	Definir i,j,k,l,p,u Como Entero;
...
SubProceso realizarpalo (alturapalo)
	Definir  i,j,k,l,p,u Como Entero;
...
Proceso sin_titulo
	...
	realizarflecha(alturaflecha);
	realizarpalo(alturapalo);
FinProceso
